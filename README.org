...
The example code brings up a minimal [[http://threejs.org/][three.js]] environment coded in ClojureScript.
...
That brings up a terminal REPL and hot-reloading of files.
